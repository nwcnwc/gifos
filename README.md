...
Default apps come organized in folders — **Games** (Tic-Tac-Toe, Connect Four, Minesweeper, Chess Tournament with time controls), **Studio** (Paint), **Tools** (Notes, Calculator, Timer & Stopwatch, Fortune), **Social** (Guestbook, Chat), and **IRL Games** — party games for game night where everyone joins from their own phone (Fake Facts, One Clue, Same Brain, One Night Wolves) with pass-the-phone versions in a **Single Phone** subfolder (Odd Word Out, Catch the Spy, Tilt, The Dial, Party Roulette) — plus **Welcome** and **Video Call** right on the Home Screen. Every icon is a genuine App GIF with animated artwork on a transparent background, drawn in the computer's **icon pack** — gifos.app ships **Aurora**, holographic glass; each numbered computer (0–9.gifos.app) gets its own art language (see `site/js/gifos-themes.js`).
