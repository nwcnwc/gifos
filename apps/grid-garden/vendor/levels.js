// English-only extract of thomaspark/gridgarden. Original is MIT.
var levels = [
  {
  ...
  },
  {
    ...
    "classes": {
      "#garden > *, #plants > *": "grid-column-start-1"
    },
    "before": "#garden {\n  display: grid;\n  grid-template-columns: 20% 20% 20% 20% 20%;\n  grid-template-rows: 20% 20% 20% 20% 20%;\n}\n\n#water {\n  grid-column-start: 1;\n",
    "after": "}"
  },
  {
    ...
    "classes": {
      "#garden > *, #plants > *": "grid-column-start-5"
    },
    "before": "#garden {\n  display: grid;\n  grid-template-columns: 20% 20% 20% 20% 20%;\n  grid-template-rows: 20% 20% 20% 20% 20%;\n}\n\n#water {\n  grid-column-start: 5;\n",
    "after": "}"
  },
  ...
  },
  {
    ...
    "classes": {
      "#garden > *, #plants > *": "grid-column-start-2"
    },
    "before": "#garden {\n  display: grid;\n  grid-template-columns: 20% 20% 20% 20% 20%;\n  grid-template-rows: 20% 20% 20% 20% 20%;\n}\n\n#water {\n  grid-column-start: 2;\n",
    "after": "}"
  },
  ...
  },
  {
    ...
    "classes": {
      "#garden > *, #plants > *": "grid-column-end-6"
    },
    "before": "#garden {\n  display: grid;\n  grid-template-columns: 20% 20% 20% 20% 20%;\n  grid-template-rows: 20% 20% 20% 20% 20%;\n}\n\n#water {\n",
  ...
  },
  {
    ...
    "classes": {
      "#plants": "grid-template-columns-repeat-8-12"
    },
    "before": "#garden {\n  display: grid;\n",
    "after": "  grid-template-rows: 20% 20% 20% 20% 20%;\n}\n\n#water {\n  grid-column: 1;\n  grid-row: 1;\n}"
  },
  {
    ...
    "classes": {
      "#plants": "grid-template-columns-100px-3em-40p"
    },
    "before": "#garden {\n  display: grid;\n",
    "after": "  grid-template-rows: 20% 20% 20% 20% 20%;\n}"
  },
  {
    ...
    "classes": {
      "#plants": "grid-template-columns-1fr-5fr"
    },
    "before": "#garden {\n  display: grid;\n",
    "after": "  grid-template-rows: 20% 20% 20% 20% 20%;\n}"
  },
...
var levelWin = {
  "name": "win",
  "instructions": {
    "en": "<p>You win! By the power of CSS grid, you were able to grow enough carrots for Froggy to bake his world famous 20-carrot cake. What, were you expecting a different hoppy friend?</p><p>If you enjoyed Grid Garden, be sure to check out Flexbox Froggy to learn about another powerful new feature of CSS layout. You can also find new coding games over at Codepip.</p><p>Want to support Grid Garden? Spread the word to your friends and family about Grid Garden!</p>"
  },
  "board": "",
  "classes": {
    "#garden, #plants, #overlay": "win"
  },
  "style": {},
  "before": "#pond {\n  display: flex;\n",
  "after": "}"
