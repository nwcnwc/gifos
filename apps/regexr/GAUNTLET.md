...
| Live matches | highlight + count + hover, JS RegExp | in |
...
Upstream's CodeMirror editors, PHP/PCRE engine, and community pattern catalog are not in the sandbox; this copy is JavaScript-only, with recents instead of a server-side library.
