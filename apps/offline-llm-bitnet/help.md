...
The first time this computer installs it, you wait for a **one-time download of about 1.03 GB** — the model's data, kept on this device. After that, answers never need the network.
