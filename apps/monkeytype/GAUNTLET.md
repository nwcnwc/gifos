...
A stranger who knows monkeytype.com would use this copy because it is the same test — words, quotes, yellow caret, WPM/acc — with no account, personal bests inside the GIF, and a live race from one invite.

## Bars

- **ONE:** monkeytype.com — the public typing test everyone screenshots. Words/quotes, live caret, wpm + acc, themes, Tab to restart.
- **TWO:** no account, works offline, personal bests live in the GIF, invite is a live race with no server.
...
The original's hundreds of languages, funboxes, and the full quote bank are not in this GIF (english + 1k + 82 quotes). The test itself is the thing people open the site for.
