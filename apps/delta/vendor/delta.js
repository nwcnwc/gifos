Delta = function() {
  ...
  var cfg = {
    ...
    images: [
      { id: "sprites", url: (window.DELTA_ASSETS && window.DELTA_ASSETS["images/sprites.png"]) },
      { id: "aliens",  url: (window.DELTA_ASSETS && window.DELTA_ASSETS["images/aliens.png"]) },
      { id: "rocks",   url: (window.DELTA_ASSETS && window.DELTA_ASSETS["images/rocks.png"]) },
      { id: "bullets", url: (window.DELTA_ASSETS && window.DELTA_ASSETS["images/bullets.png"]) }
    ],
