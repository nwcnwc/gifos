/* GENERATED by apps/stolen-sword/vendor.mjs from chiaogu/stolen-sword@e5aa6e06ce50545df80e5bdfdde4122b5e267d09.
...
const lemniscateMovement = (duration, radius, startTime = 0) => {
  let radiusProgress = 0;
  return objectAction(
    duration,
    (object, progress) => {
...
const fire = (interval, startTime = 0) =>
  objectEvent(
    (enemy) => {
      if (!enemy[KEY_ENEMY_DEAD_FRAME]) {
  ...
  [KEY_STAGE_ENDING_CUT_SCENE]: [
    [
      () => {
        ...
        $cameraLoop.$ = undefined;
        $tempPlayerPos.$ = vector(player.p.x, player.p.y);
        tempCamCenter4 = vector(cameraCenter.x, cameraCenter.y);
        graphics.push(
          ...letterBox(),
          fakeMountain
        );
    ...
    [
      (progress) => {
        cameraCenter.y = lerp(tempCamCenter4.y, player.p.y - 30, easeInOutQuad(progress));
      },
      1000,
    ],
    [() => {
    ...
    [
      (progress) => {
        cameraCenter.x = lerp(tempCamCenter4.x, 130, easeInOutQuad(progress));
