...
export function screenshotPng(){
  ...
  fill(40,40,W-40,H-40,245,245,245);
  fill(80,520,520,560,51,51,51);
  fill(560,520,1120,560,210,210,210);
  fill(400,380,900,420,51,51,51);
  fill(200,240,240,320,51,51,51);
  fill(980,300,1100,340,51,51,51);
  fill(1020,248,1060,300,80,80,80);
  for(let i=0;i<8;i++) fill(700+i*16,548,708+i*16,560,180,40,40);
