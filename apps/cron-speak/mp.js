/* Optional meeting: a read-only view of the host's expression.
...
(function (root) {
  ...
  function snapshot() {
    ...
    return {
      ...
      expr: s.expr || '', h24: !!s.h24, verbose: !!s.verbose, dow0: s.dow0 !== false
    };
  }
  function publish() {
  ...
  function statusOf() {
    if (guest) return 'Showing a read-only view of the host\'s sentence.';
    return 'Press Invite (top bar) to show this sentence, read-only, in a meeting.';
  }
