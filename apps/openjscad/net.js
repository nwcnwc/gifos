/* Invite shares the host's script. Guests watch; they orbit their own view.
...
(function (root) {
  ...
  function statusOf() {
    if (guest) return 'This is the host\'s script. Orbit the model — it updates when they run.';
    return 'Press Invite in the bar above. A friend who opens the link gets this script.';
  }
