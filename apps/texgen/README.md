...
Procedural textures, live. Stack layers, download a PNG. Nothing is uploaded.
...
strings with `new Function`, which the sandbox CSP refuses.

```
index.html      canvas, layer list, params
