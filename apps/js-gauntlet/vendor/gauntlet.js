Gauntlet = function() {
  ...
  var cfg = {
    ...
    images: [
      { id: 'backgrounds', url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["images/backgrounds.png"]) }, // http://opengameart.org/content/gauntlet-like-tiles
      { id: 'entities',    url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["images/entities.png"]) }  // http://opengameart.org/forumtopic/request-for-tileset-spritesheet-similar-to-gauntlet-ii 
    ],

    sounds: [],

    levels: [
      { name: 'Test Level',     url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/testlevel.png"]), floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: null }, 
      { name: 'Training',       url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer1.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Shoot ghosts and find the exit" },
      { name: 'Training Two',   url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer2.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Watch out for demon fire" },
      { name: 'Training Three', url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer3.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Find keys to open doors" },
      { name: 'Training Four',  url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer4.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Eat and drink to restore health" },
      { name: 'Training Five',  url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer5.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Collect treasure for high score" },
      { name: 'Training Six',   url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer6.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Destroy monster generators" },
      { name: 'Training Seven', url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/trainer7.png"]),  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Use potions to destroy all monsters" },
      { name: 'Dungeon One',    url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level1.png"]),    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  1000, help: "Training is over!<br><br> Welcome to the Dungeon!" },
      { name: 'Dungeon Two',    url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level2.png"]),    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  2000, help: null },
      { name: 'Dungeon Three',  url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level3.png"]),    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  3000, help: null },
      { name: 'Dungeon Four',   url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level4.png"]),    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  4000, help: null },
      { name: 'Dungeon Five',   url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level5.png"]),    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  5000, help: null },
      { name: 'Dungeon Six',    url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level6.png"]),    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  6000, help: null },
      { name: 'Dungeon Seven',  url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level7.png"]),    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.PURPLE_COBBLE,    music: 'thebeginning',    score:  7000, help: null },
      { name: 'Dungeon Eight',  url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level8.png"]),    floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'mountingassault', score:  8000, help: null },
      { name: 'Dungeon Nine',   url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level9.png"]),    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.CONCRETE,         music: 'fleshandsteel',   score:  9000, help: null },
      { name: 'Dungeon Ten',    url: (window.GAUNTLET_ASSETS && window.GAUNTLET_ASSETS["levels/level10.png"]),   floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'warbringer',      score: 10000, help: "Final Level<br><br>Good Luck!" }
    ],
