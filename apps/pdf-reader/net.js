/* Last file is private. The host's PDF is read-only for guests. The follow
 * cursor (page + optional pointer) is the live room. Invite is OS chrome. */
(function (root) {
  'use strict';
