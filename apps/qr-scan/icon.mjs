...
export function screenshotPng() {
  ...
  drawText(put, 600, 220, 'DECODED', 3, 154, 148, 134);
  rr(600, 270, 1136, 400, 10, 16, 16, 24);
  drawText(put, 624, 318, 'GIFOS.APP', 4, 244, 241, 232);

  drawText(put, 600, 450, 'TAKE A PHOTO OR DROP A PICTURE', 3, 154, 148, 134);
  drawText(put, 600, 510, 'NO LIVE CAMERA. HISTORY STAYS HERE.', 3, 154, 148, 134);
