  ...
  var Engine = window.Engine = {
    ...
    init: function(options) {
      ...
      if($SM.get('config.lightsOff') === false){
        var darkSheet = Engine.findStylesheet('darkenLights');
    ...
    import64: function(string64) {
      ...
      if (typeof Engine._softReload === 'function') Engine._softReload();
    },
...
/* GifOS boot.js calls Engine.init() after gifos.db hydrate. */
