...
export function screenshotPng() {
  ...
  drawText(put, 64, 110, 'TYPE TEXT. GET A CODE. NOTHING UPLOADED.', 3, 154, 148, 134);
  ...
  drawText(put, 600, 220, 'TEXT OR URL', 3, 154, 148, 134);
  rr(600, 270, 1136, 400, 10, 16, 16, 24);
  drawText(put, 624, 318, 'GIFOS.APP', 4, 244, 241, 232);

  drawText(put, 600, 450, 'LAST TEXT STAYS IN THIS FILE', 3, 154, 148, 134);
